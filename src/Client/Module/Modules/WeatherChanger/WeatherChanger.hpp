...
public:
    ...
    WeatherChanger() : Module("Weather Changer", "Changes the weather ingame.", "\\Musui\\assets\\cloudy.png", 'o') {
    ...
    void SettingsRender() override {
        ...
        MusuiGUI::MusuiTextWithFont(toggleX, toggleY, L"Rain", textWidth * 3.0f, textHeight,
                                        DWRITE_TEXT_ALIGNMENT_LEADING,
                                        Constraints::RelativeConstraint(0.12, "height", true),
                                        DWRITE_FONT_WEIGHT_NORMAL);

        float percent = MusuiGUI::Slider(4, toggleX + MusuiGUI::SettingsTextWidth("Rain "),
        ...
        MusuiGUI::MusuiTextWithFont(toggleX, toggleY, L"Lightning", textWidth * 3.0f, textHeight,
                                        DWRITE_TEXT_ALIGNMENT_LEADING,
                                        Constraints::RelativeConstraint(0.12, "height", true),
                                        DWRITE_FONT_WEIGHT_NORMAL);

        percent = MusuiGUI::Slider(5, toggleX + MusuiGUI::SettingsTextWidth("Lightning "),
        ...
        MusuiGUI::MusuiTextWithFont(toggleX + Constraints::SpacingConstraint(0.60, textWidth / 2.0f), toggleY,
