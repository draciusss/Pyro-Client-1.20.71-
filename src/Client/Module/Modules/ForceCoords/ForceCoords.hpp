...
public:
	...
	ForceCoords() : Module("Coordinates", "Shows your ingame position. (XYZ)", "\\Musui\\assets\\coordinates.png", 'o') {
	...
	void SettingsRender() override {
		...
		toggleY += Constraints::SpacingConstraint(0.35, textWidth);
        MusuiGUI::MusuiTextWithFont(toggleX + Constraints::SpacingConstraint(0.60, textWidth), toggleY,
                                        MusuiGUI::to_wide("Mojang Style").c_str(), textWidth * 6.9f, textHeight,
                                        DWRITE_TEXT_ALIGNMENT_LEADING, Constraints::SpacingConstraint(1.05, textWidth),
                                        DWRITE_FONT_WEIGHT_NORMAL);
		if (MusuiGUI::Toggle(9, toggleX, toggleY, this->settings.getSettingByName<bool>(
