...
public:
    ...
    CPSCounter() : Module("CPS", "Counts your Clicks per second.", "\\Musui\\assets\\cursor.png", 'L') {
    ...
    void SettingsRender() override {
        ...
        percent = MusuiGUI::Slider(5, toggleX + Constraints::SpacingConstraint(1.2, textWidth),
        ...
        MusuiGUI::MusuiTextWithFont(toggleX + Constraints::SpacingConstraint(0.60, textWidth), toggleY,
                                        MusuiGUI::to_wide("Right CPS").c_str(), textWidth * 6.9f, textHeight,
