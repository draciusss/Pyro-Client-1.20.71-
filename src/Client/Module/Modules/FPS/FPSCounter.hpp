...
public:
    ...
    void SettingsRender() override {
        ...
        percent = MusuiGUI::Slider(1, toggleX + Constraints::SpacingConstraint(0.60, textWidth) +
        ...
        MusuiGUI::MusuiTextWithFont(toggleX, toggleY, L"FPS Spoofer", textWidth * 3.0f, textHeight,
                                        DWRITE_TEXT_ALIGNMENT_LEADING,
                                        Constraints::RelativeConstraint(0.12, "height", true),
                                        DWRITE_FONT_WEIGHT_NORMAL);

        percent = MusuiGUI::Slider(69, toggleX + MusuiGUI::SettingsTextWidth("FPS Spoofer "),
