...
public:
    ...
    MovableChat() : Module("Movable Chat", "Makes the Minecraft chat movable.", "\\Musui\\assets\\man.png", 'Y') {
    ...
    void SettingsRender() override {
        ...
        float percent = MusuiGUI::Slider(3, toggleX + Constraints::SpacingConstraint(0.65, textWidth),
                                           toggleY,
