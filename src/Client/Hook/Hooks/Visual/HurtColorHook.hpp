	...
	static MCCColor* HurtColorCallback(void* a1, MCCColor* color, void* a3) {
		...
		if (ModuleManager::getModule("Hurt Color") != nullptr ) {
            ...
            if(ModuleManager::getModule("Hurt Color")->settings.getSettingByName<bool>("enabled")->value) {
                ...
                D2D1_COLOR_F color2;
                if (ModuleManager::getModule("Hurt Color")->settings.getSettingByName<bool>("color_rgb")->value) color2 = MusuiGUI::rgbColor;
                else color2 = MusuiGUI::HexToColorF(ModuleManager::getModule("Hurt Color")->settings.getSettingByName<std::string>("color")->value);
